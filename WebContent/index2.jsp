...
<body id="myPage">
	...
	<div id="about" class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<center><span class="glyphicon glyphicon-heart logo slideanim"></span></center>
			</div>
		</div>
	</div>
	...
	<div id="contact" class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-5">
				...
				<p><span class="glyphicon glyphicon-phone"></span> +91 9767168505</p>
				<p><span class="glyphicon glyphicon-envelope"></span> info@idealevent.com</p>
				<p><span class="glyphicon glyphicon-phone"></span> +91 8098763175</p>
				<p><span class="glyphicon glyphicon-envelope"></span> query@idealevent.com</p>
			</div>
	...
	<script>
		function myMap() {
			var myCenter = new google.maps.LatLng(20.236932, 85.724867);
	...
	<footer class="container-fluid text-center">
		...
		<strong><p>Designed By <a href="https://www.casts.co.in">CASTS.PVT.LTD</a></p></strong>
	</footer>
